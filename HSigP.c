...
/* Sunit function to write data to file*/

void sunit_write(Vector s,int frameSize){

	FILE *fid;
	char data[frameSize+1];
	char path[]="/home/speech/Desktop/test.txt";
	printf("-----------------\n"); 
/*	char path[]="test.txt";*/
...
/*End of Sunit function to write data to file*/
